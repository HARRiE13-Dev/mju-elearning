        ...
        <div class="container pt-lg pb-80">
          <div class="row justify-content-center">
            <div class="fontx col-lg-10">
                  ...
                  <div class="col">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>แทรกคำอธิบายเพิ่มเติมลงไปตรงข้อความที่ต้องการอธิบาย(Endnote)</td>
                          <td>Alt + Ctrl + D</td>
                        </tr>
                        <tr>
                          <td>แทรกคำอภิบายเพิ่มเติมลงทางด้านล่างของหน้ากระดาษ(Footnote)</td>
                          <td>Alt + Ctrl + F</td>
                        </tr>
                        <tr>
              ...
              <p>
                ถ้างานที่คุณพิมพ์ในโปรแกรมไมโครซอฟต์เวิร์ดเป็นเอกสารที่เป็นความลับหรือค่อนข้างสำคัญ เราสามารถใส่รหัสป้องกันได้ด้วยการคลิก
                แฟ้ม > ข้อมูล > ป้องกันเอกสาร > เข้ารหัสลับด้วยรหัสผ่าน > ใส่รหัสผ่าน > ตกลง
              </p>
              ...
              <h5>- การใส่ลายน้ำ</h5>
              <p>
                ลายน้ำคือข้อความ อักษร หรืออาจจะเป็นรูปภาพที่ปรากฏอยู่ด้านหลังข้อความบนหน้าเอกสาร ซึ่งจะเพิ่มความน่าสนใจของเอกสารมากยิ่งขึ้น
                ไปที่ เค้าโครงหน้ากระดาษ > ลายน้ำ > เลือกแบบตามตัวอย่างหรือกำหนดเอง
                <br />
              </p>
              <div class="text-center">
              ...
              <br />
              <h5>- การใส่ลายน้ำ</h5>
              <p></p>เริ่มจากไปที่เมนู มุมมอง > แมโคร > ตั้งชื่อ แมโคร (ใช้ภาษาอังกฤษ ห้ามเว้นวรรค สามารถใช้ขีดล่างได้) > กดปุ่มสร้าง >
              ในหน้าพิมพ์คำสั่ง แมโคร โดยให้ลบโค้ดเก่าออกให้หมด > พิมพ์โค้ดด้านล่างนี้แทน > กดปุ่มบันทึก
              <br />
              <br />
              <div class="container">
                <div class="row">
              ...
              <p>
                โดยเวลาเรียกใช้งาน ให้ไปที่ มุมมอง > แมโคร อีกครั้งจะเจอเมนู arabictothai กับ thaitoarabic
                ก็สามารถเลือกรูปแบบที่เราต้องการจากนั้นกดปุ่ม เรียกใช้ ตัวเลขบนเอกสารทั้งหมดก็จะเปลี่ยนทั้งหมด
                <br />
                <br />
              </p>
