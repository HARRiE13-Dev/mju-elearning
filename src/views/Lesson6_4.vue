          ...
          <div class="row justify-content-center">
            <div class="fontx col-lg-10">
              ...
              <p class="rem2 text-justify">
                ...
                สามารถทำให้เกิดการกระจายอำนาจให้องค์กรการบุกรุกสิทธิส่วนบุคคลขอผู้อื่นหรือของคู่แข่งขัน
              ...
              <p class="rem2 text-justify">
                ...
                ไม่มีความเที่ยงธรรมหรือซึ่งสัตย์ในเรื่องของข้อมูลข่าวสารแล้วย่อมล่อแหลมต่อความเสียหายในองค์กรมีตัวอย่าง
                เช่น
              ...
              <p class="rem5">
                ...
                คือเพียงแต่ลองใช้ดูก่อนที่จะซื้อเท่านั้น
              ...
              <p class="rem5">
                ...
                แต่ทำไม่สมบูรณ์ไม่อาจทดสอบ และส่งมอบให้ได้ภายในเวลาที่สัญญาไว้
                หรือส่งให้ได้แต่มีข้อผิดพลาด
                การที่ผู้พัฒนาผลิตซอฟต์แวร์ได้รุ่นที่ไม่สมบูรณ์เช่นนี้จำเป็นต้องบอกลูกค้าให้ชัดเจนใช้หรือไม่
              </p>
              <br />
              <h4>
                ความสัมพันธ์ระหว่างคอมพิวเตอร์ และปัญหาด้านจริยธรรม
                (Computer-related ethical issues)
              </h4>
              <p class="rem2">
                สิ่งที่ต้องคำนึงถึง และถือว่าเป็นมิติของจรรยาบรรณสำหรับผู้ทำงานกับระบบข้อมูลข่าวสารสามารถแบ่งออกได้เป็น
                4 ส่วนด้วยกัน คือ
              </p>
              <p class="rem2">
              ...
              <p class="rem2">
                ...
                ๆ
                สิทธิ์ในการเป็นเจ้าของข้อมูล และโปรแกรมอย่างถูกต้องนั้นยังเป็นคำถามที่ยากต่อการตอบในเชิงจริยธรรมเป็นอย่างยิ่ง
                กฎหมายทรัพย์สินทางปัญญาได้มีผลคุ้มครองต่อความถูกต้องของวิชาชีพ และนักเขียนโปรแกรมคอมพิวเตอร์
                ถึงแม้ว่าทรัพย์สินทางปัญญาของเขาจะมีลักษณะแตกต่างจากทรัพย์สินชนิดอื่น
                ๆ เช่น บ้าน รถยนต์
                อย่างไรก็ตามการพิจารณาในเรื่องข้อมูลข่าวสาร และองค์ความรู้มักเป็นเรื่องที่ชี้ชัดให้เกิดความกระจ่างได้ยาก
              </p>
              <p class="rem2">
              ...
              <p class="rem2">
                ...
                แน่นอน ตายตัวว่ามีอะไรบ้าง
                หากแต่ผู้ใช้ และนักวิชาชีพคอมพิวเตอร์ต้องตระหนัก และมีจิตสำนึก
              ...
              <p class="rem5">
                (2)
                พิจารณาถึงกลุ่มบุคคลที่จะได้ประโยชน์จากการกระทำของเรา เป็นต้นว่าเป็นบุคคลกลุ่มใหญ่บุคคลกลุ่มน้อยหรือได้รับประโยชน์เฉพาะตัวเราเท่านั้น
              </p>
              <p class="rem5">
                (3) การมีนโยบายบริหารและจัดการข้อมูลอย่างคงเส้นคงวาของบริษัท
                ไม่ว่าจะโดยทางตรงหรือทางอ้อมก็ตาม
                ต้องยืดไว้ซึ่งความถูกต้อง และยุติธรรม รวมทั้งการไม่รับสินบนใด ๆ
                จากบริษัทผู้ขาย
              </p>
              <p class="rem5">
                (4) การกระทำใด ๆ
              ...
              <br />
              <h4>
                ทัศนะทางจริยธรรม 5 ประการ ของยุคสารสนเทศ (Five moral dimensions
                of the information age) มีดังนี้
              </h4>
              <p class="rem2">
                1. สิทธิด้านสารสนเทศและพันธะหน้าที่ (Information rights and
                obligations) สิทธิด้านสารสนเทศอะไรที่องค์กรพึงมี
                และความรับผิดอะไรที่บุคคลและองค์กรพึงมี
              </p>
              <p class="rem2">
                2. สิทธิของทรัพย์สิน (Property rights)
                ในสังคมที่ไม่มีความชัดเจนในเรื่องสิทธิของทรัพย์สิน
                จะต้องพิจารณาสังคมนั้นควรจะมีการปกป้องสิทธิทรัพย์สินทางปัญญาอย่างไร
              </p>
              <p class="rem2">
                3. ความรับผิดชอบในหน้าที่ และการควบคุม (Accountability and
                control)
                การพิจารณาถึงบุคคลที่จะเป็นผู้ที่รับผิดชอบในสิ่งที่เกิดขึ้นที่เป็นอันตรายต่อสิทธิของบุคคล
                สิทธิของสารสนเทศ และสิทธิของทรัพย์สิน
              </p>
              <p class="rem2">
                4. คุณภาพระบบ (System quality)
                เป็นการพิจารณาว่าระบบควรมีมาตรฐานและคุณภาพ
                เพื่อการปกป้องสิทธิส่วนบุคคล และความปลอดภัยของสังคม
              </p>
              <p class="rem2">
                5. คุณภาพชีวิต (Quality of life)
                เป็นการพิจารณาว่าค่านิยมใดที่ควรจะรักษาไว้ในสังคมที่ใช้ข่าวสารโดยมีความรู้พื้นฐาน
                สถาบันใดที่ควรจะได้รับการปกป้องให้พ้นจากการละเมิดฝ่าฝืน
                การละเมิดค่านิยม และความประพฤติด้านสังคม
                การประพฤติเชิงสังคมอย่างไรที่ควรจะได้รับการสนับสนุนจากระบบสารสนเทศ
                [Information systems (IS)] ใหม่ ๆ
              </p>
              <br />
              <h4>จริยธรรมในสังคมสารสนเทศ</h4>
              <p class="rem2">
                จริยธรรมในสังคมสารสนเทศ (Ethics in an information society)
                เป็นเรื่องเกี่ยวกับทางเลือกของบุคคล เมื่อต้องเผชิญในการปฏิบัติ
                ซึ่งจะต้องพิจารณาว่าอะไรเป็นทางเลือกที่ถูกต้องตามหลักจริยธรรม
              </p>
              <p class="rem2">
                แนวคิดพื้นฐาน : ความรับผิดชอบ ภาระหน้าที่
                และภาระผูกพันการชำระหนี้ (Basic concepts : Responsibility,
                Accountability and liability) ประกอบด้วย
              </p>
              <p class="rem5">
                1. ความรับผิดชอบ (Responsibility) เป็นลักษณะเฉพาะของบุคคล
                และเป็นองค์ประกอบหลักในการกระทำ
              </p>
              <p class="rem5">
                2. ภาระหน้าที่ (Accountability)
                เป็นลักษณะของระบบ และสถาบันทางสังคม
              ...
              <p class="rem5">
                ...
                รวมถึงระบบ และองค์กรด้วย
              </p>
              <p class="rem5">
                4. กระบวนการในการยื่นอุทธรณ์ (Due process)
                เป็นลักษณะที่เกี่ยวข้องกับสังคมที่ใช้กฎหมายในการปกครอง
              ...
              <p class="rem2">
                ...
                การก้าวก่ายสิทธิเสรีภาพในการแสดงออก
                ซึ่งเป็นสิทธิพื้นฐานของประชาชน
                ยังอาจจะขัดต่อกฎหมายรัฐธรรมนูญของประเทศอีกด้วย
                อีกทั้งลักษณะพิเศษของข้อมูลต่าง ๆ ที่อยู่ในเครือข่ายอินเทอร์เน็ต
                เป็นเครือข่ายที่มีลักษณะเป็นใยแมงมุม
                ซึ่งระบบกระจายความรับผิดชอบไม่มีศูนย์กลางของระบบ
                และเป็นเครือข่ายข้อมูลระดับโลกยากต่อการควบคุม
              ...
              <p class="rem2">
                ...
                ในแต่ละประเทศยังเป็นปัญหาอุปสรรค
              ...
              <p class="rem2">
                ...
                ได้ท้าทายกฎหมายให้คุ้มครองในเรื่องทรัพย์สินทางปัญญา
                เพราะเนื่องจากมีการขโมย และการลักลอบเลียนแบบซอฟต์แวร์
              </p>
              <p class="rem2">
                ทรัพย์สินทางปัญญา (Intellectual property)
                เป็นทรัพย์สินที่จับต้องไม่ได้ ถูกสร้างโดยบุคคล หรือบริษัท
                และอยู่ภายใต้การคุ้มครองของกฎหมาย 3 ประการ ดังนี้ (1)
                ความลับทางการค้า (Trade secrets) (2) ลิขสิทธิ์ (Copyright) (3)
                สิทธิบัตร (Patents) การคุ้มครองทั้ง 3 แบบ
                เป็นแบบการคุ้มครองที่แตกต่างกันในเรื่องของ ซอฟต์แวร์ (Software)
              </p>
              <p class="rem2">
                ระบบความปลอดภัย (Security systems)
                เนื่องจากว่าระบบข้อมูลข่าวสารเป็นหัวใจสำคัญในการบริหารงานในปัจจุบัน
                ...
                แท้จริงแล้วคำว่า
                ระบบความปลอดภัยในที่นี้จะหมายความถึงการป้องกันการลักลอบขโมย และทำลายทรัพยากรที่เกี่ยวข้องกับระบบคอมพิวเตอร์
                เช่น ฮาร์ตแวร์ ซอฟต์แวร์ ข้อมูล
                วิธีการดำเนินงาน และบุคลากรทางด้านคอมพิวเตอร์
              </p>
              <p class="rem2">
                ระบบความปลอดภัยสำหรับคอมพิวเตอร์
                และข้อมูลสารสนเทศนั้นมีขึ้นมากเป็นลำดับ จากคอมพิวเตอร์ขนาดใหญ่
                ซึ่งเป็นแบบรวมศูนย์
                ต่อมาการติดต่อแลกเปลี่ยนข้อมูลกับคอมพิวเตอร์ลูกข่ายมีมากขึ้น
                เนื่องจากลูกข่ายมีลักษณะงานจำเพาะแตกต่างกันออกไป
                องค์กรขนาดใหญ่บางองค์กรใช้ระบบ EDI กับลูกข่ายด้วย
                ดังนั้นการควบคุมรักษาความปลอดภัยของข้อมูลจากส่วนกลาง
                ไม่สามารถทำได้อย่างทั่วถึง
                อุปสรรค์ในการรักษาความปลอดภัยมีเพิ่มมากขึ้นพร้อม ๆ
                กับการขยายตัวขององค์กร
              </p>
              <br />
              <h4>
                ประเทศไทยกับการพัฒนากฎหมายเทคโนโลยีสารสนเทศ และอินเทอร์เน็ต
              </h4>
              <p class="rem2">
                กฎหมายเทคโนโลยีสารสนเทศของประเทศไทยเริ่มมีตั้งแต่ปี 2541 โดยคณะกรรมการเทคโนโลยีสารสนเทศแห่งชาติ และมีการใช้ พระราชบัญญัติ
                (พ.ร.บ.) ว่าด้วยการกระทำความผิดเกี่ยวกับคอมพิวเตอร์ พ.ศ.2560
                เพื่อการใช้ออนไลน์อย่างถูกกฎหมาย
                สำหรับสาระสำคัญที่หลายคนควรพึงระวังใน
                พ.ร.บ.ว่าด้วยกระทำความผิดเกี่ยวกับคอมพิวเตอร์ พ.ศ. 2560 หรือ
                พ.ร.บ.คอมพิวเตอร์ ฉบับ 2 มีสาระสำคัญจำง่ายๆ ดังนี้
              </p>
              <p class="rem5">
              ...
              <p class="rem5">
                ...
                หากข้อมูลที่แชร์มีผลกระทบต่อผู้อื่น อาจเข้าข่ายความผิดตาม
                พ.ร.บ.คอมพิวเตอร์ โดยเฉพาะที่กระทบต่อบุคคลที่ 3
              </p>
              <p class="rem5">
              ...
              <p class="rem5">
                ...
                เมื่อพบข้อความที่ผิด พ.ร.บ.คอมพิวเตอร์
              ...
              <p class="rem5">
                11. การโพสต์ด่าว่าผู้อื่น มีกฏหมายอาญาอยู่แล้ว ไม่มีข้อมูลจริง
                หรือถูกตัดต่อ ผู้ถูกกล่าวหา เอาผิดผู้โพสต์ได้
              ...
              <p class="rem2 font-italic">
                ทั้งหมดนี้เป็นเพียงส่วนหนึ่งของ พ.ร.บ.คอมพิวเตอร์ 2560
                ที่มีผลบังคับใช้แล้ว
                ซึ่งยังมีอีกหลายประเด็นที่ส่งผลกระทบต่อการใช้งานสื่อสังคมออนไลน์
                ดังนั้นจึงควรรู้กฎกติกาการใช้งานไว้ก่อน และยังมี พระราชบัญญัติการรักษาความมั่นคง ปลอดภัยไซเบอร์ พ.ศ.2562 
              </p>
              <hr>
